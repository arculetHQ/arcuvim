...
function M.setup()
    ...
    -- For bufferline.nvim
    vim.keymap.set('n', 'gb', ':BufferLineCycleNext<CR>', {})
    vim.keymap.set('n', 'gB', ':BufferLineCyclePrev<CR>', {})
    vim.keymap.set('n', 'mn', ':BufferLineMoveNext<CR>', {})
    vim.keymap.set('n', 'mp', ':BufferLineMovePrev<CR>', {})
end
